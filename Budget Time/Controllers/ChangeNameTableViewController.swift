...
//  Budget Time
//
//  Created by Kanoa Matton on 5/2/20.
...
class ChangeNameTableViewController: UITableViewController {
    ...
    func updateSaveButtonState() {
        let updateName = updateNameTextField.text ?? ""
        
        saveButton.isEnabled = !updateName.isEmpty
    }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        defaults.set(updateNameTextField.text, forKey: "Name")
